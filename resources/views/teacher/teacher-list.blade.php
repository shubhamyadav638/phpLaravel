                         ...
                         <table class="table datatable">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <a onclick="editTeacher({{$teacher->id}})"
                                             class="btn btn-sm btn-primary">edit</a>
                                         <a href="" class="btn btn-sm btn-danger"
                                             onclick="deleteTeacher({{$teacher->id}})">delete</a>
                                     </td>
                                 </tr>
                                 @endforeach
                             </tbody>
...
function addTeacher() {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            $('#mainbodymodel').modal(
                'show'
                ); // ye  id main modle ki hogi  or btn pr data-bs-toggle="modal" data-bs-target="#basicModal" ye dono hata ke onclick laga denge
